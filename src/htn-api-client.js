...
export async function getBlock(hash) {
    const res = await fetch(`${API_BASE}blocks/${hash}`, { headers: { mode: 'no-cors' } })
...
export async function getTransaction(hash) {
    const res = await fetch(`${API_BASE}transactions/${hash}`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data
        })
...
export async function getBlockdagInfo() {
    const res = await fetch(`${API_BASE}info/blockdag`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data
        })
...
export async function getCoinSupply() {
    const res = await fetch(`${API_BASE}info/coinsupply`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data
        })
...
export async function getAddressBalance(addr) {
    const res = await fetch(`${API_BASE}addresses/${addr}/balance`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data.balance
        })
...
export async function getAddressTxCount(addr) {
    const res = await fetch(`${API_BASE}addresses/${addr}/transactions-count`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data.total
        })
...
export async function getAddressUtxos(addr) {
    const res = await fetch(`${API_BASE}addresses/${addr}/utxos`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data
        })
...
export async function getHalving() {
    const res = await fetch(`${API_BASE}info/halving`, { headers: { mode: 'no-cors' } })
        .then((response) => response.json())
        .then(data => {
            return data
        })
